...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/avito-android/flexsearch.min.js');loadScript('/avito-android/ru.search-data.min.77c6cc3f06a4f6681a15647ca47f596488745bcbc0806d7e7f2e970aaac0fca4.js',function(){input.required=false;search();});}
